...
<body>
	...
	<div class="slider-area">
		<div class="slider-wrapper owl-carousel">
			<div
				class="slider-item text-center home-one-slider-otem slider-item-four slider-bg-one">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="slider-content-area">
								<div class="slide-text">
									<h1 class="homepage-three-title">
										Welcome to <span><%=Constants.PROJECT_NAME%></span> by <span>
											<%=Constants.COMPANY_SHORT_NAME%></span>
									</h1>
									<h2>
										<%=Constants.PROJECT_ABSTRACT%>
									</h2>
									<div class="slider-content-btn">
										<a class="btn11" href="register.jsp">Register
											<div class="transition"></div>
										</a> <a class="btn11" href="login.jsp">Login
											<div class="transition"></div>
										</a>
									</div>
								</div>
