			...
			<div class='col-md-12'>
				...
				<table class='table'>
					<tr>
						...
						<br/>
						<a href='mailbox_trash.jsp' style='width:100%; text-align: left;' class='btn btn-primary'><i class='fa fa-trash'></i> Trash</a>
						<br/>
						...
						<%
							...
							List<Mail> inboxMails = mDao.getTrash(u1.getEmail());
								...
								%>
									...
									<%
										...
										for (Mail m: inboxMails)
										{
											...
											else if (m.getNb().equals("spam") || m.getHmm().equals("spam"))
											{
												%>
									...
									%>
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<a href='mailbox?request_type=restore&id=<%=m.getId()%>'><i class='fa fa-recycle'></i></a>
														      ...
														      <div class="modal-header">
														        <h4 class="modal-title" id="myModalLabel" style='color: gray;' >Read Mail</h4>
															      ...
															      <div class="modal-footer">
																	...
																	<a class='btn btn-danger' href='mailbox?request_type=restore&id=<%=m.getId()%>'><i class='fa fa-recycle'></i> Restore</a>
