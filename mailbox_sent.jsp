			...
			<div class='col-md-12'>
				...
				<table class='table'>
					<tr>
						...
						<br/>
						<a href='mailbox_sent.jsp' style='width:100%; text-align: left;' class='btn btn-primary'><i class='fa fa-send'></i> Sent</a>
						<br/>
						...
						<%
							...
							List<Mail> inboxMails = mDao.getSent(u1.getEmail());
							...
							else
							{
								%>
									...
									<%
										...
										{
											i++;
											User us = uDao.getUserDetails(m.getRec());
											%>
