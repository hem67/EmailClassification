			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbar">
					<ul class="navbar-nav ml-auto">
						...
						<li><a class="active" href="run.jsp">Run</a></li>
	...
	<div id="features" class="section wb">
		<div class="container">
			<div class="section-title text-center">
				<h3>Run</h3>
				<p class="lead">Here, you can run the Email Classification Algorithm</p>
			</div>
			<!-- end title -->
			...
			<div class='col-md-8'>
							...
							<%
								...
								{
								   %>
								   		<h3>The Algorithm execution is in-progress. Please check the results after some time.</h3>
								   <%
								}
								else
								{
								  %>
							   			...
							   			{
							   				%>
							   					<h3>The Algorithm Results are available. You can check the results <a href='results.jsp'>here</a></h3>
							   					<hr/>
							   					<h3>Are you sure to Run the algorithm again?</h3>
							   				<%
							   			}
								   		%>
								   		<form action='run'>
								   			<input type=hidden name='requestType' value='run' />
								   			<input type=submit class='btn btn-primary col-md-6' value='Run Email Classification Algorithm '/>
								   		</form>
								   <%								   
								}
							%>
