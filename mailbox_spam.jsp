		...
		<div class="container">
			...
			<div class='col-md-12'>
				...
				<table class='table'>
					<tr>
						<td style='width:15%;'>
						<a href='mailbox_inbox.jsp' style='width:100%; text-align: left;' class='btn btn-default'><i class='fa fa-inbox'></i> Inbox</a>
						<br/>
						...
						<br/>
						<a href='mailbox_spam.jsp' style='width:100%; text-align: left;' class='btn btn-primary'><i class='fa fa-remove'></i> Spam</a>
						</td>
						<td style='width:85%;'>
						...
						<%
							...
							List<Mail> inboxMails = mDao.getSpam(u1.getEmail());
								...
								%>
									...
									<%
										...
										for (Mail m: inboxMails)
										{
											...
											{
												%>
												<tr style='background-color: red; color: white;' title='HMM:<%=m.getHmm()%>, NB: <%=m.getNb()%> '>
									...
									%>
												...
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<a href='mailbox?request_type=movetotrashfromspam&id=<%=m.getId()%>'><i class='fa fa-trash'></i></a>
														      ...
														      <div class="modal-header">
														        <h4 class="modal-title" id="myModalLabel" style='color: gray;' >Read Mail</h4>
															      ...
															      <div class="modal-footer">
																	...
																	<a class='btn btn-danger' href='mailbox?request_type=movetotrashfromspam&id=<%=m.getId()%>'><i class='fa fa-trash'></i> Move To Trash</a>
