	...
	<div id="features" class="section wb">
		<div class="container">
			<div class="section-title text-center">
				...
				<p class="lead">Please change your password regularly to keep your profile secure</p>
			</div>
			<!-- end title -->
			...
			<div class='col-md-8'>
						...
						<label> Email ID </label> <input type=text readonly="readonly"
							...
							placeholder='New Password' /> <br /><br /> 				<button class="btn btn-warning" type="submit">Change Password</button>
					</form>
