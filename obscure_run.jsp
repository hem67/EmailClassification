			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbar">
					<ul class="navbar-nav ml-auto">
						...
						<li><a class="active" href="#" class="dropdown-toggle" data-toggle="dropdown">Obscure</a>
							          <ul class="dropdown-menu">
	...
	<div id="features" class="section wb">
		<div class="container">
			<div class="section-title text-center">
				<h3>Obscure</h3>
				<p class="lead">You can obscure your datasets here. This provides privacy preservation of the emails.</p>
			</div>
			<!-- end title -->
			...
			<div class='col-md-8'>
							...
							<%
								String check = (String) session.getAttribute("obscure_inprogress");
								if (check != null && check.equals("yes"))
								{
								   %>
								   		<h4>The Obscure process is in Progress.</h4>
								   <%
								} 
								else 
								{
							...
							<form action='obscure' method=post >
					   			<input type=hidden name='requestType' value='run' />
					   			<br/>
					   			<br/>
					   			<input type=submit value='Start Obscure Process' class='btn btn-primary'/>
